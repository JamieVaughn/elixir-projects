defmodule Day2Test do
  ...
  test "transformGames" do
    assert Day2.transformGames("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
    Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
    Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
    Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
    Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green") == [
      %{game: 1, blue: [6, 3], red: [4, 1], green: [2, 2], impossible: 0},
      %{blue: [4, 1, 1], game: 2, green: [3, 2, 1], red: [1], impossible: 0},
      %{blue: [6, 5], game: 3, green: [13, 8, 5], red: [20, 4, 1], impossible: 1},
      %{blue: [15, 6], game: 4, green: [3, 3, 1], red: [14, 6, 3], impossible: 2},
      %{blue: [2, 1], game: 5, green: [3, 2], red: [6, 1], impossible: 0}
    ]
  end
  
  test "sumPossibleGames" do
    assert Day2.sumPossibleGames("Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
    Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
  ...
  test "sumPossibleGames2" do
    assert Day2.sumPossibleGames("Game 85: 15 green, 2 blue, 11 red; 4 red, 7 blue, 6 green; 3 blue, 14 green; 10 green, 10 blue, 7 red; 17 red, 3 green, 15 blue
    ...
    Game 94: 1 green, 2 blue, 10 red; 7 red, 3 blue; 1 blue, 6 red, 4 green") == 451
  end
  
  # @tag :skip
  test "part1" do
    assert Day2.sumPossibleGames("Game 1: 2 green, 12 blue; 6 red, 6 blue; 8 blue, 5 green, 5 red; 5 green, 13 blue; 3 green, 7 red, 10 blue; 13 blue, 8 red
  ...
  test "part2" do
    assert Day2.maxPower("Game 1: 2 green, 12 blue; 6 red, 6 blue; 8 blue, 5 green, 5 red; 5 green, 13 blue; 3 green, 7 red, 10 blue; 13 blue, 8 red
    Game 2: 1 green, 7 red; 1 green, 9 red, 3 blue; 4 blue, 5 red
    Game 3: 2 red, 2 blue, 6 green; 1 blue, 2 red, 2 green; 3 blue, 3 green
    Game 4: 8 green, 16 red, 7 blue; 1 red, 7 blue, 12 green; 8 green, 14 red, 1 blue; 6 blue, 9 green, 12 red; 9 red, 2 green; 8 red, 7 blue, 17 green
    Game 5: 2 red, 7 green; 2 red, 1 green, 4 blue; 4 blue, 7 green, 5 red; 8 red, 2 blue, 5 green
