defmodule Day2Test do
  ...
  test "transformGames" do
    ...
    Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green") == [
      %{game: 1, blue: [3, 6], red: [4, 1], green: [2, 2], impossible: 0},
      %{blue: [1, 4, 1], game: 2, green: [2, 3, 1], red: [1], impossible: 0},
      %{blue: [6, 5], game: 3, green: [8, 13, 5], red: [20, 4, 1], impossible: 1},
      %{blue: [6, 15], game: 4, green: [1, 3, 3], red: [3, 6, 14], impossible: 2},
      %{blue: [1, 2], game: 5, green: [3, 2], red: [6, 1], impossible: 0}
    ]
  end
  ...
  test "part1" do
    ...
    Game 100: 8 green, 7 blue, 1 red; 10 blue, 2 green, 5 red; 12 blue, 1 green, 1 red; 9 green, 9 blue, 2 red; 1 blue, 5 red, 3 green") == 2771
  end
end